...
<body>
    ...
    <div class="contenedor-general contenedor-areas-pacientes">
        <div class="titulo-general titulo-areas-pacientes">Áreas-Pacientes</div>
    ...
    FROM
        areas_pacientes ap
    INNER JOIN
        areas a ON ap.id_area = a.id_area
    INNER JOIN
        pacientes pa ON ap.id_paciente = pa.id_paciente
    INNER JOIN
